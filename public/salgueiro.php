...
<body>
  ...
  <div class="p-6">
    <div class="max-w-[1450px] mx-auto">
      <h2 class="text-3xl font-bold">Salgueiro Maia</h2>
      ...
      <div class="mt-6">
        <?php if (($cargo === "Guia" || $cargo === "Sub Guia") && $equipa === "Salgueiro Maia"): ?>
          <a href="form_add.php?equipa=Salgueiro Maia" class="bg-blue-400 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-500">
            Adicionar Pioneiro
          </a>
        <?php endif; ?>
      </div>
