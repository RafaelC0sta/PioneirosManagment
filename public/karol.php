...
<body>
    ...
    <div class="p-6">
        <div class="max-w-[1450px] mx-auto">
            <h2 class="text-3xl font-bold">Karol Wojtyla</h2>
                    ...
                    <table class="w-full min-w-full border-collapse">
                        <thead class="bg-gray-600 text-white">
                            <tr>
                                ...
                                <?php if (($cargo === "Guia" || $cargo === "Sub Guia") && $equipa === "Karol Wojtyla"): ?>
                        ...
                        <tbody class="divide-y">
                            <?php 
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if (($cargo === "Guia" || $cargo === "Sub Guia") && $equipa === "Karol Wojtyla") {
            ...
            <div class="mt-6">
                <?php if (($cargo === "Guia" || $cargo === "Sub Guia") && $equipa === "Karol Wojtyla"): ?>
                    <a href="form_add.php?equipa=Karol Wojtyla" class="bg-blue-400 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-500">
                        Adicionar Pioneiro
                    </a>
                <?php endif; ?>
            </div>
